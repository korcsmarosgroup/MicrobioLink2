...
Detailed plan for the third module described in @plans/microbiolink_refactoring.md, following the
decisions in @plans/refactoring_questions.md and the precedent set by
@plans/module_2_membrane_filter.md. Scope is exactly Module 3: resolving a set of human or
