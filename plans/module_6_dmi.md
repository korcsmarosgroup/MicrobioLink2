...
Detailed plan for the sixth module described in @plans/microbiolink_refactoring.md, following the
decisions in @plans/refactoring_questions.md and the precedent set by
@plans/module_1_zscore_filter.md through @plans/module_5_ddi.md. Scope is exactly Module 6: given
