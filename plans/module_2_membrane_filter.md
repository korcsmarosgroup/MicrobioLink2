...
Detailed plan for the second module described in @plans/microbiolink_refactoring.md, following
the decisions in @plans/refactoring_questions.md. Scope is exactly Module 2: filtering a set of
