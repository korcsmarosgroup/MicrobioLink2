...
4. API Documentation. The API documentation should use mkdocstrings to generate this from the docstrings of the public documentation. This should be sense checked to ensure that the wording makes sense. It would be good to divide the API documentation up into the modules and "essential" functions for runnign the pipeline versus "helper" functions
