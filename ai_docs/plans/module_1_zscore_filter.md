...
Detailed plan for the first module described in @ai_docs/plans/microbiolink_refactoring.md, following
the decisions in @ai_docs/plans/refactoring_questions.md. Scope is exactly Module 1: filtering a gene
...
- `case-study:workflow/z-score_filter_terminal.py` — **ground truth** (ties to
  `ai_docs/plans/refactoring_questions.md` Q11: case-study always wins over beta on overlapping logic).
